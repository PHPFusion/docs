...
* [private $error](../classes/PHPFusion.LostPassword.md#property_error)
* [private $html](../classes/PHPFusion.LostPassword.md#property_html)
* [private $userName](../classes/PHPFusion.LostPassword.md#property_userName)
* [private $userEmail](../classes/PHPFusion.LostPassword.md#property_userEmail)
* [private $newPassword](../classes/PHPFusion.LostPassword.md#property_newPassword)
---
### Methods
...
* [public sendPasswordRequest()](../classes/PHPFusion.LostPassword.md#method_sendPasswordRequest)
* [public checkPasswordRequest()](../classes/PHPFusion.LostPassword.md#method_checkPasswordRequest)
* [public renderInputForm()](../classes/PHPFusion.LostPassword.md#method_renderInputForm)
* [public displayOutput()](../classes/PHPFusion.LostPassword.md#method_displayOutput)
* [public displayErrors()](../classes/PHPFusion.LostPassword.md#method_displayErrors)
...
* [private isValidEMailAddress()](../classes/PHPFusion.LostPassword.md#method_isValidEMailAddress)
* [private sendNewPassword()](../classes/PHPFusion.LostPassword.md#method_sendNewPassword)
---
### Details
* File: [classes\PHPFusion\LostPassword.php](../files/classes.PHPFusion.LostPassword.md)
* Package: Default
* Class Hierarchy: 
  * [\PHPFusion\PasswordAuth](../classes/PHPFusion.PasswordAuth.md)
  * \PHPFusion\LostPassword
---
## Properties
...
<a name="method_sendPasswordRequest" class="anchor"></a>
#### public sendPasswordRequest() : boolean&amp;#124;null

```
public sendPasswordRequest(string  $email) : boolean&amp;#124;null
```

**Details:**
* Inherited From: [\PHPFusion\LostPassword](../classes/PHPFusion.LostPassword.md)
##### Parameters:
| Type | Name | Description |
| ---- | ---- | ----------- |
...
<a name="method_checkPasswordRequest" class="anchor"></a>
#### public checkPasswordRequest() : boolean

```
public checkPasswordRequest(string  $email, string  $password) : boolean
```
...
<a name="method_renderInputForm" class="anchor"></a>
#### public renderInputForm() : boolean
...
<a name="method_displayOutput" class="anchor"></a>
...
<a name="method_displayErrors" class="anchor"></a>
...
<a name="method_isValidEMailAddress" class="anchor"></a>
#### private isValidEMailAddress() : boolean

```
private isValidEMailAddress(string  $email) : boolean
```
...
<a name="method_sendNewPassword" class="anchor"></a>
