...
* [public verify_contact()](../classes/Contact.md#method_verify_contact)
---
### Details
* File: [defender\validation\contact.php](../files/defender.validation.contact.md)
* Package: Default
* Class Hierarchy: 
...
<a name="method_verify_contact" class="anchor"></a>
#### public verify_contact() 
...
**Details:**
* Inherited From: [\Contact](../classes/Contact.md)
