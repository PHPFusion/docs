...
* [protected verify_checked()](../classes/Checkbox.md#method_verify_checked)
---
### Details
* File: [defender\validation\checkbox.php](../files/defender.validation.checkbox.md)
* Package: Default
* Class Hierarchy: 
...
<a name="method_verify_checked" class="anchor"></a>
#### protected verify_checked() 
...
**Details:**
* Inherited From: [\Checkbox](../classes/Checkbox.md)
