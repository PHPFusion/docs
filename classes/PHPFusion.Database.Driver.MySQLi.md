...
# Class: \PHPFusion\Database\Driver\MySQLi
...
* [private $connection](../classes/PHPFusion.Database.Driver.MySQLi.md#property_connection)
---
### Methods
...
* [public close()](../classes/PHPFusion.Database.Driver.MySQLi.md#method_close)
* [public isClosed()](../classes/PHPFusion.Database.AbstractDatabaseDriver.md#method_isClosed)
* [public isConnected()](../classes/PHPFusion.Database.Driver.MySQLi.md#method_isConnected)
...
* [public fetchAssoc()](../classes/PHPFusion.Database.Driver.MySQLi.md#method_fetchAssoc)
* [public fetchAllRows()](../classes/PHPFusion.Database.AbstractDatabaseDriver.md#method_fetchAllRows)
* [public fetchRow()](../classes/PHPFusion.Database.Driver.MySQLi.md#method_fetchRow)
...
* [public count()](../classes/PHPFusion.Database.Driver.MySQLi.md#method_count)
* [public fetchFirstColumn()](../classes/PHPFusion.Database.Driver.MySQLi.md#method_fetchFirstColumn)
* [public countRows()](../classes/PHPFusion.Database.Driver.MySQLi.md#method_countRows)
* [public countColumns()](../classes/PHPFusion.Database.Driver.MySQLi.md#method_countColumns)
* [public getLastId()](../classes/PHPFusion.Database.Driver.MySQLi.md#method_getLastId)
* [public quote()](../classes/PHPFusion.Database.Driver.MySQLi.md#method_quote)
* [public getServerVersion()](../classes/PHPFusion.Database.Driver.MySQLi.md#method_getServerVersion)
* [protected connect()](../classes/PHPFusion.Database.Driver.MySQLi.md#method_connect)
* [protected _query()](../classes/PHPFusion.Database.Driver.MySQLi.md#method__query)
---
### Details
* File: [classes\PHPFusion\Database\Driver\MySQLi.php](../files/classes.PHPFusion.Database.Driver.MySQLi.md)
* Package: Default
* Class Hierarchy: 
  * [\PHPFusion\Database\AbstractDatabaseDriver](../classes/PHPFusion.Database.AbstractDatabaseDriver.md)
  * \PHPFusion\Database\Driver\MySQLi
---
## Constants
...
#### private $connection : \mysqli|NULL
---
**Type:** \mysqli|NULL
...
**Details:**
* Inherited From: [\PHPFusion\Database\Driver\MySQLi](../classes/PHPFusion.Database.Driver.MySQLi.md)
...
#### public fetchAssoc() : array&amp;#124;boolean

```
public fetchAssoc(mixed  $result) : array&amp;#124;boolean
```
...
**Returns:** array&#124;boolean - Associative array
...
#### public fetchRow() : array&amp;#124;boolean

```
public fetchRow(mixed  $result) : array&amp;#124;boolean
```
...
**Returns:** array&#124;boolean - Numeric array
...
```
public fetchFirstColumn(mixed  $result, integer  $row) : mixed
```
...
```
public countRows(mixed  $result) : integer
```
...
```
public countColumns(mixed  $result) : integer
```
...
#### protected _query() : boolean&amp;#124;\mysqli_result

```
protected _query(string  $query, array  $parameters = array()) : boolean&amp;#124;\mysqli_result
```
...
**Returns:** boolean&#124;\mysqli_result - The result of the query or FALSE on error
