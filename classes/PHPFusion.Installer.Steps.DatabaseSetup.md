...
# Class: \PHPFusion\Installer\Steps\DatabaseSetup
...
* [public view()](../classes/PHPFusion.Installer.Steps.DatabaseSetup.md#method_view)
...
* [protected doCoreBatch()](../classes/PHPFusion.Installer.Steps.DatabaseSetup.md#method_doCoreBatch)
* [protected doUpgradeBatch()](../classes/PHPFusion.Installer.Steps.DatabaseSetup.md#method_doUpgradeBatch)
* [protected makeSqlImportLog()](../classes/PHPFusion.Installer.Steps.DatabaseSetup.md#method_makeSqlImportLog)
...
* [private dispatchTables()](../classes/PHPFusion.Installer.Steps.DatabaseSetup.md#method_dispatchTables)
* [private stepForm()](../classes/PHPFusion.Installer.Steps.DatabaseSetup.md#method_stepForm)
---
### Details
* File: [classes\PHPFusion\Installer\Steps\DatabaseSetup.php](../files/classes.PHPFusion.Installer.Steps.DatabaseSetup.md)
...
* Class Hierarchy:  
  ...
  * \PHPFusion\Installer\Steps\DatabaseSetup
---
## Constants
...
**Details:**
* Inherited From: [\PHPFusion\Installer\Steps\DatabaseSetup](../classes/PHPFusion.Installer.Steps.DatabaseSetup.md)
...
<a name="method_doCoreBatch" class="anchor"></a>
#### protected doCoreBatch() : boolean

```
protected doCoreBatch(string  $query) : boolean
```
...
```
protected doUpgradeBatch(string  $method, array  $code_array) : boolean
```
...
| <code>array</code> | $code_array  |  |

**Returns:** boolean


<a name="method_makeSqlImportLog" class="anchor"></a>
#### protected makeSqlImportLog() : string

```
protected makeSqlImportLog(string  $comment_message, array  $array, boolean  $_SDK = FALSE) : string
```
...
| Type | Name | Description |
| ---- | ---- | ----------- |
| <code>string</code> | $comment_message  |  |
| <code>array</code> | $array  |  |
| <code>boolean</code> | $_SDK  |  |
...
<a name="method_dispatchTables" class="anchor"></a>
#### private dispatchTables() : string
...
<a name="method_stepForm" class="anchor"></a>
#### private stepForm() : string
