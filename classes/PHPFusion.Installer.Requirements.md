...
# Class: \PHPFusion\Installer\Requirements
...
* [public getSystemRequirements()](../classes/PHPFusion.Installer.Requirements.md#method_getSystemRequirements)
* [public getSystemValidation()](../classes/PHPFusion.Installer.Requirements.md#method_getSystemValidation)
...
<a name="method_getSystemRequirements" class="anchor"></a>
#### public getSystemRequirements() : array

```
Static public getSystemRequirements() : array
```
...
**Details:**
* Inherited From: [\PHPFusion\Installer\Requirements](../classes/PHPFusion.Installer.Requirements.md)

**Returns:** array


<a name="method_getSystemValidation" class="anchor"></a>
#### public getSystemValidation() : array

```
Static public getSystemValidation() : array
```
