...
* [public display_search()](../classes/PHPFusion.Search.md#method_display_search)
* [public render_search()](../classes/PHPFusion.Search.md#method_render_search)
* [public render_search_no_result()](../classes/PHPFusion.Search.md#method_render_search_no_result)
* [public render_search_count()](../classes/PHPFusion.Search.md#method_render_search_count)
* [public render_search_item()](../classes/PHPFusion.Search.md#method_render_search_item)
* [public render_search_item_list()](../classes/PHPFusion.Search.md#method_render_search_item_list)
* [public render_search_item_image()](../classes/PHPFusion.Search.md#method_render_search_item_image)
* [public render_search_item_wrapper()](../classes/PHPFusion.Search.md#method_render_search_item_wrapper)
...
---
### Details
* File: [classes\PHPFusion\Search.php](../files/classes.PHPFusion.Search.md)
* Package: PHPFusion
* Class Hierarchy:  
  * [\PHPFusion\Search\Search_Model](../classes/PHPFusion.Search.Search_Model.md)
  * [\PHPFusion\Search\Search_Engine](../classes/PHPFusion.Search.Search_Engine.md)
  * \PHPFusion\Search
---
## Properties
...
<a name="method_display_search" class="anchor"></a>
#### public display_search() 

```
Static public display_search() 
```
...
**Details:**
* Inherited From: [\PHPFusion\Search](../classes/PHPFusion.Search.md)




<a name="method_render_search" class="anchor"></a>
#### public render_search() : string

```
Static public render_search() : string
```
...
<a name="method_render_search_no_result" class="anchor"></a>
#### public render_search_no_result() : string

```
Static public render_search_no_result() : string
```
...
<a name="method_render_search_count" class="anchor"></a>
#### public render_search_count() : string

```
Static public render_search_count() : string
```
...
<a name="method_render_search_item" class="anchor"></a>
#### public render_search_item() 

```
Static public render_search_item(  $new_window = FALSE) 
```
...
| Type | Name | Description |
| ---- | ---- | ----------- |
| <code></code> | $new_window  |  |




<a name="method_render_search_item_list" class="anchor"></a>
#### public render_search_item_list() 

```
Static public render_search_item_list() 
```
...
<a name="method_render_search_item_image" class="anchor"></a>
#### public render_search_item_image() : string

```
Static public render_search_item_image() : string
```
...
<a name="method_render_search_item_wrapper" class="anchor"></a>
#### public render_search_item_wrapper() : string

```
Static public render_search_item_wrapper() : string
```
